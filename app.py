    ...
    st.markdown("""
        <style>
            ...
            .custom-card {
                ...
                justify-content: space-between; /* 내용과 버튼 사이 간격 벌림 */
                align-items: center;
                box-shadow: 0 10px 25px rgba(0,0,0,0.2);
                transition: transform 0.3s ease, box-shadow 0.3s ease;
                pointer-events: none; /* 클릭 통과 (뒤에 있는 버튼이 눌리게) */
                z-index: 1;
            }

            /* 카드 호버 애니메이션 (투명 버튼 호버 시 같이 반응하도록 설정은 어렵지만, 기본 그림자 유지) */
            ...
            .card-title { font-size: 1.6rem; font-weight: 800; margin-bottom: 10px; }
            .card-desc { font-size: 1rem; opacity: 0.9; font-weight: 400; line-height: 1.5; color: rgba(255,255,255,0.9); }
            ...
            .inner-btn span { margin-right: 5px; }
            ...
            /* 북한: 로즈 레드 그라데이션 */
            .theme-north {
                background: linear-gradient(145deg, #881337 0%, #e11d48 100%);
            ...
            /* 4. 실제 작동하는 투명 버튼 (Ghost Button) */
            div.stButton > button {
                width: 100% !important;
                height: 300px !important; /* 카드 높이와 동일 */
                margin-top: -316px !important; /* 위로 끌어올려 겹침 (카드높이 + 마진보정) */
...
if st.session_state.step == 0:
    ...
    with c1:
        # [HTML] 카드 + 내부 가짜 버튼
        st.markdown("""
        <div class="custom-card theme-south">
    ...
    with c2:
        st.markdown("""
        <div class="custom-card theme-north">
            <div class="card-content">
                <div class="card-icon">🏔️</div>
    ...
    with c3:
        st.markdown("""
        <div class="custom-card theme-debug">
            <div class="card-content">
                <div class="card-icon">🛠️</div>
