...
def run_analysis_action(txt, img_bytes=None):
    ...
    with st.spinner("AI가 분석 중입니다..."):
        ...
        1. **원본**: 
           ...
           - 주의2 : 단어 뒤에 붙은 마침표(.), 물음표(?), 느낌표(!), 쉼표(,) 등은 삭제하지 말고 원본에 그대로 적으십시오.
        ...
        2. **원형**: 
           ...
           {special_rule_for_north}
           - 명사 : 붙어있는 조사(은/는/이/가/을/를/의/에/에서/로/으로 등)를 확실하게 제거하고 명사 단어만 남기십시오.
           ...
           - 조사, 단순 어미는 추출 대상에서 확실하게 제외하십시오.
             (주의: '일', '분', '개' 등 의미가 있는 단어는 절대 제외하지 말고 추출하십시오.)
